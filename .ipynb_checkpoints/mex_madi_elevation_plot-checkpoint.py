...
object_fdets.plot_parameters_error_bounds(extracted_data_ur, suppress = False)
...
ur_madi = object_fdets.get_allan_index(extracted_data_ur, tau_min = 0, tau_max = 10, save_dir = os.path.join(allan_folder, 'On'),suppress = False)
